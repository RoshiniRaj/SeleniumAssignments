...
public class Service_DeleteOrder {
	...
	public static void main(String[] args) {
		...
		String orderNum = driver.findElement(By.id("requesturl")).getText();
		...
		driver.switchTo().frame("gsft_main");
		driver.findElement(By.xpath("//input[@class='form-control']")).sendKeys(orderNum,Keys.ENTER);
